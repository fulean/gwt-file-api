...
/**
 * Represents a native media abort event.
 * <p>
...
public class AbortEvent extends DomEvent<AbortHandler> {
  ...
  /**
   * Event type for media abort events. Represents the meta-data associated with
   * this event.
   */
  ...
  /**
   * Gets the event type associated with media abort events.
   * 
