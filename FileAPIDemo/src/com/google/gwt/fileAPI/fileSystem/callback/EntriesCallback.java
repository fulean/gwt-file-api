 ...
 * @see <a
 *      href="http://www.w3.org/TR/file-system-api/#idl-def-EntriesCallback">http://www.w3.org/TR/file-system-api/#idl-def-EntriesCallback</a>
 */
public interface EntriesCallback {
  void handleEvent(JsArray<Entry> entries);
}
